...
<section class="apple-hero relative overflow-hidden bg-white">
    <div class="apple-container text-center relative z-10">
        ...
        <div class="fade-in-up mt-12" style="animation-delay: 0.2s;">
            <img src="{{ get_site_url() }}/wp-content/uploads/2022/07/clinic.png"
    ...
    <div class="apple-container">
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div class="w-full lg:w-[62%] fade-in-up" style="animation-delay: 0.15s;">
                <img src="{{ get_site_url() }}/wp-content/uploads/2022/08/clinic-dashboard.png"
    ...
    <div class="apple-container">
        ...
        <div class="grid lg:grid-cols-2 gap-x-20 gap-y-20 max-w-5xl mx-auto">
            ...
            <div class="fade-in-up" style="animation-delay: 0.1s;">
                ...
                <div class="flex flex-wrap gap-3 text-sm font-medium text-[#1d1d1f]">
                    <span class="px-3 py-1.5 bg-white rounded-full border border-gray-200">Design</span><span class="mt-1 text-gray-400">→</span>
                    <span class="px-3 py-1.5 bg-white rounded-full border border-gray-200">Milling</span><span class="mt-1 text-gray-400">→</span>
                    <span class="px-3 py-1.5 bg-white rounded-full border border-gray-200">Finishing</span><span class="mt-1 text-gray-400">→</span>
                    <span class="px-3 py-1.5 bg-white rounded-full border border-gray-200">QC</span><span class="mt-1 text-gray-400">→</span>
                    <span class="px-3 py-1.5 bg-[#0071e3] text-white rounded-full">Delivery</span>
                </div>
            </div>
            <div class="fade-in-up">
...
<section class="apple-section apple-section--dark relative overflow-hidden">
    <div class="apple-container relative z-10">
        ...
        <div class="flex flex-col lg:flex-row items-stretch gap-6 max-w-5xl mx-auto">
            <div class="flex-1 apple-glass-card p-8 fade-in-up" style="animation-delay: 0.1s;"><p class="apple-glass-text font-medium">DentalSO Lab MES</p></div>
            <div class="flex-1 apple-glass-card p-8 fade-in-up" style="animation-delay: 0.15s;"><p class="apple-glass-text font-medium">Case management system</p></div>
            <div class="flex-1 apple-glass-card p-8 fade-in-up" style="animation-delay: 0.2s;"><p class="apple-glass-text font-medium">Production scheduling</p></div>
            <div class="flex-1 apple-glass-card p-8 fade-in-up" style="animation-delay: 0.25s;"><p class="apple-glass-text font-medium">Quality control workflow</p></div>
        </div>
