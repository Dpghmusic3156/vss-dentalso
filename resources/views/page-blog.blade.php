...
<section class="apple-section apple-hero bg-white">
    <div class="apple-container text-center">
        <div class="fade-in-up">
            <span class="apple-eyebrow">Blog DentalSO</span>
            <h1 class="apple-headline mb-6">Tin tức & Cập nhật</h1>
            <p class="apple-hero-copy">
                Xu hướng ngành, cập nhật sản phẩm và các phương pháp tối ưu cho Labo và phòng khám nha khoa.
            </p>
        </div>
    </div>
</section>
    ...
    <div class="apple-container">
                ...
                <div class="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 grid lg:grid-cols-2">
                    ...
                    <div class="p-8 lg:p-12 flex flex-col justify-center">
                        <div class="flex items-center gap-3 mb-4">
                            <span class="inline-block px-3 py-1 bg-[#0071e3]/10 text-[#0071e3] text-xs font-semibold rounded-full uppercase tracking-wide">Nổi bật</span>
                            <span class="text-sm text-[#86868b]">{{ get_the_date('d/m/Y', $featured) }}</span>
                        </div>
                        ...
                        <span class="text-[#0071e3] font-semibold text-sm inline-flex items-center gap-1">
                            Đọc bài viết <span class="material-symbols-outlined text-lg">arrow_forward</span>
                        </span>
                    </div>
                </div>
            </a>
                           ...
                           style="animation-delay: {{ $loop->index * 0.06 }}s;">
                            ...
                            <div class="p-6 flex flex-col flex-1">
                                <div class="flex items-center gap-2 mb-3">
                                    ...
                                    @endif
                                    <span class="text-xs text-[#86868b]">{{ get_the_date('d/m/Y', $post) }}</span>
                                </div>
                                ...
                                <span class="mt-4 text-[#0071e3] font-medium text-sm inline-flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    Đọc thêm <span class="material-symbols-outlined text-base">chevron_right</span>
                                </span>
                            </div>
                        </a>
                    @endforeach
        ...
        @else
            ...
            <div class="text-center py-20 fade-in-up max-w-lg mx-auto">
                ...
                <p class="apple-body">Chúng tôi đang chuẩn bị các bài viết chuyên sâu về quản lý Labo, tối ưu sản xuất và quy trình số hóa. Hãy theo dõi nhé!</p>
