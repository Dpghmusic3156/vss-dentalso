    ...
    <div class="apple-container text-center">
        ...
        <div class="fade-in-up mt-10" style="animation-delay: 0.2s;">
            <div class="bg-white rounded-2xl overflow-hidden p-1 max-w-5xl mx-auto">
                <img src="{{ get_theme_mod('trang_chu.banner.hinh_2') }}" alt="DentalSO MES Dashboard — Real-time production monitoring" class="rounded-xl w-full">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="apple-split-text fade-in-up">
                ...
                <ul class="space-y-3">
                    <li class="flex items-start gap-3">
                        <span class="material-symbols-outlined text-[#0071e3] text-xl mt-0.5">visibility</span>
                        <span class="text-[#1d1d1f] text-[0.9375rem]">Active cases by production stage</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="material-symbols-outlined text-[#0071e3] text-xl mt-0.5">group</span>
                        <span class="text-[#1d1d1f] text-[0.9375rem]">Technician workload distribution</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="material-symbols-outlined text-[#ff453a] text-xl mt-0.5">warning</span>
                        <span class="text-[#1d1d1f] text-[0.9375rem]">Delayed or at-risk cases flagged instantly</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="material-symbols-outlined text-[#30d158] text-xl mt-0.5">check_circle</span>
                        <span class="text-[#1d1d1f] text-[0.9375rem]">Completed and ready-for-delivery cases</span>
                    </li>
                </ul>
            </div>
...
<section class="apple-section bg-white">
    <div class="apple-container">
        ...
        <div class="max-w-4xl mx-auto mb-16 fade-in-up">
            <div class="flex flex-wrap justify-center gap-2 text-sm font-medium text-[#1d1d1f]">
                <span class="px-4 py-2 bg-[#e3f0fc] text-[#0071e3] rounded-full font-semibold">Intake</span>
                <span class="mt-2 text-[#d2d2d7]">→</span>
                <span class="px-4 py-2 bg-[#f5f5f7] rounded-full border border-[#d2d2d7]">Design</span>
                <span class="mt-2 text-[#d2d2d7]">→</span>
                <span class="px-4 py-2 bg-[#f5f5f7] rounded-full border border-[#d2d2d7]">CAM</span>
                <span class="mt-2 text-[#d2d2d7]">→</span>
                <span class="px-4 py-2 bg-[#f5f5f7] rounded-full border border-[#d2d2d7]">Milling / Printing</span>
                <span class="mt-2 text-[#d2d2d7]">→</span>
                <span class="px-4 py-2 bg-[#f5f5f7] rounded-full border border-[#d2d2d7]">Finishing</span>
                <span class="mt-2 text-[#d2d2d7]">→</span>
                <span class="px-4 py-2 bg-[#f5f5f7] rounded-full border border-[#d2d2d7]">Quality Control</span>
                <span class="mt-2 text-[#d2d2d7]">→</span>
                <span class="px-4 py-2 bg-[#f5f5f7] rounded-full border border-[#d2d2d7]">Packaging</span>
                <span class="mt-2 text-[#d2d2d7]">→</span>
                <span class="px-4 py-2 bg-[#30d158] text-white rounded-full font-semibold">Delivery</span>
            </div>
        </div>
        ...
        <div class="apple-split apple-split--reverse">
            <div class="apple-split-text fade-in-up">
                ...
                <ul class="space-y-3">
                    <li class="flex items-start gap-3">
                        <span class="material-symbols-outlined text-[#30d158] text-xl mt-0.5">check_circle</span>
                        <span class="text-[#1d1d1f] text-[0.9375rem]">Deadline-aware case prioritization</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="material-symbols-outlined text-[#30d158] text-xl mt-0.5">check_circle</span>
                        <span class="text-[#1d1d1f] text-[0.9375rem]">Capacity-driven workload balancing</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="material-symbols-outlined text-[#30d158] text-xl mt-0.5">check_circle</span>
                        <span class="text-[#1d1d1f] text-[0.9375rem]">Auto-calculated production queue</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="material-symbols-outlined text-[#30d158] text-xl mt-0.5">check_circle</span>
                        <span class="text-[#1d1d1f] text-[0.9375rem]">Guided technician task lists</span>
                    </li>
                </ul>
            </div>
            <div class="apple-split-media fade-in-up" style="animation-delay: 0.15s;">
        ...
        <div class="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div class="apple-card apple-card--white fade-in-up" style="animation-delay: 0.05s;">
                <div class="apple-card-inner">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start gap-3">
                            <span class="material-symbols-outlined text-[#0071e3] text-xl mt-0.5">checklist</span>
                            <span class="text-[#1d1d1f] text-[0.9375rem]">Prioritized task list</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="material-symbols-outlined text-[#0071e3] text-xl mt-0.5">arrow_forward</span>
                            <span class="text-[#1d1d1f] text-[0.9375rem]">Next best case to process</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="material-symbols-outlined text-[#ff453a] text-xl mt-0.5">schedule</span>
                            <span class="text-[#1d1d1f] text-[0.9375rem]">Cases nearing deadline</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="material-symbols-outlined text-[#ff9f0a] text-xl mt-0.5">block</span>
                            <span class="text-[#1d1d1f] text-[0.9375rem]">Blocked cases flagged</span>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="apple-card apple-card--white fade-in-up" style="animation-delay: 0.1s;">
                <div class="apple-card-inner">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start gap-3">
                            <span class="material-symbols-outlined text-[#bf5af2] text-xl mt-0.5">crisis_alert</span>
                            <span class="text-[#1d1d1f] text-[0.9375rem]">Bottleneck detection by department</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="material-symbols-outlined text-[#bf5af2] text-xl mt-0.5">group</span>
                            <span class="text-[#1d1d1f] text-[0.9375rem]">Overloaded technician alerts</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="material-symbols-outlined text-[#30d158] text-xl mt-0.5">battery_full</span>
                            <span class="text-[#1d1d1f] text-[0.9375rem]">Idle capacity identification</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="material-symbols-outlined text-[#ff453a] text-xl mt-0.5">warning</span>
                            <span class="text-[#1d1d1f] text-[0.9375rem]">Deadline risk indicators</span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="apple-container text-center">
        <div class="fade-in-up">
            ...
            <div class="apple-cta-group">
                ...
                <a href="{{ home_url('products/dental-case-submission-software/') }}" class="apple-cta-secondary apple-cta-secondary--light">Explore DentalSO Connect<span class="apple-chevron material-symbols-outlined">chevron_right</span></a>
            </div>
        </div>
    </div>
</section>
