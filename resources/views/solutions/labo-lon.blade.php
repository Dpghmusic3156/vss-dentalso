        ...
        <div class="apple-split apple-split--reverse">
            ...
            <div class="apple-split-media fade-in-up" style="animation-delay: 0.15s;">
                <div class="bg-[#f5f5f7] rounded-2xl shadow-lg overflow-hidden p-1">
                    <img src="{{ get_site_url() }}/wp-content/uploads/2022/08/clinic-dashboard.png" alt="DentalSO Theo Dõi Ca Sản Xuất" class="apple-split-img rounded-xl">
                </div>
            </div>
        </div>
    </div>
...
<section class="apple-section bg-[#f5f5f7]">
    <div class="apple-container">
        <div class="apple-split">
            ...
            <div class="apple-split-media fade-in-up" style="animation-delay: 0.15s;">
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden p-1">
                    <img src="{{ get_site_url() }}/wp-content/uploads/2022/12/dental-online-lab-dashboard.png" alt="DentalSO Lịch Ưu Tiên" class="apple-split-img rounded-xl">
                </div>
            </div>
        </div>
    </div>
...
<section class="apple-section bg-white">
    <div class="apple-container">
        <div class="apple-split apple-split--reverse">
            ...
            <div class="apple-split-media fade-in-up" style="animation-delay: 0.15s;">
                <div class="bg-[#f5f5f7] rounded-2xl shadow-lg overflow-hidden p-1">
                    <img src="{{ get_site_url() }}/wp-content/uploads/2022/08/clinic-dashboard.png" alt="DentalSO MES Báo cáo Cảnh báo" class="apple-split-img rounded-xl">
                </div>
            </div>
        </div>
    </div>
