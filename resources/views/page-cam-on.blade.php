    ...
    <section class="container section-first-page pt-0" data-aos="fade-up">
        ...
        <div class="section-header">
            ...
            <p class="div-center text-center">
                Chúng tôi đã nhận được yêu cầu liên hệ của bạn. Thông tin về lịch demo online sẽ được gửi qua email của bạn.</p>
            <p class="div-center text-center">
            ...
            <div class="flex items-center justify-center" >
                <span
                    ...
                    <img src="https://dentalso.com/wp-content/plugins/polylang/flags/vn.png" alt="Trang Tiếng Việt" loading="lazy"
                ...
                <img src="https://dentalso.com/wp-content/plugins/polylang/flags/us.png" alt="Trang Tiếng Anh" loading="lazy"
                    style="width: 16px; height: 11px;">
