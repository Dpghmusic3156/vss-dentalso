    ...
    <div class="apple-container text-center">
        ...
        <div class="fade-in-up mt-10" style="animation-delay: 0.2s;">
            <div class="bg-white rounded-2xl overflow-hidden p-1 max-w-5xl mx-auto shadow-sm">
                <img src="@asset('images/mes-dashboard-hero.webp')" alt="Quản lý sản xuất — Bảng điều khiển giám sát sản xuất thời gian thực - Phần mềm quản lý labo nha khoa giá rẻ, cho dùng thử miễn phí" class="rounded-xl w-full" loading="lazy">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="apple-split">
            ...
            <div class="apple-split-media fade-in-up" style="animation-delay: 0.15s;">
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden p-1">
                    <img src="{{ get_site_url() }}/wp-content/uploads/2022/12/dental-online-lab-dashboard.png" alt="Quản lý sản xuất — Dashboard giám sát sản xuất thời gian thực - Phần mềm quản lý labo nha khoa giá rẻ, cho dùng thử miễn phí" class="apple-split-img rounded-xl" loading="lazy">
                </div>
            </div>
        </div>
    </div>
...
<section class="apple-section bg-[#f5f5f7]">
    <div class="apple-container">
        <div class="apple-split apple-split--reverse">
            ...
            <div class="apple-split-media fade-in-up" style="animation-delay: 0.15s;">
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden p-1">
                    <img src="{{ get_site_url() }}/wp-content/uploads/2022/08/clinic-dashboard.png" alt="Quản lý sản xuất — Bảng sắp lịch ưu tiên sản xuất - Phần mềm quản lý labo nha khoa giá rẻ, cho dùng thử miễn phí" class="apple-split-img rounded-xl" loading="lazy">
                </div>
            </div>
        </div>
    </div>
