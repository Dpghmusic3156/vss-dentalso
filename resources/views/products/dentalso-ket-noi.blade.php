{{-- Template Name: Product: Kết nối Labo và Nha khoa --}}
@extends('layouts.app')
...
<section class="apple-hero relative overflow-hidden bg-white">
    <div class="apple-container text-center relative z-10">
        <div class="fade-in-up">
            <p class="text-sm font-semibold text-[#0071e3] tracking-wide uppercase mb-5">Kết nối Labo và Nha khoa</p>
        ...
        <div class="fade-in-up mt-12" style="animation-delay: 0.2s;">
            <img loading="lazy" src="{{ home_url('wp-content/uploads/2022/07/clinic') }}.png"
                 alt="Kết nối Labo và Nha khoa - Phần mềm quản lý labo nha khoa giá rẻ, cho dùng thử miễn phí"
...
{{-- ============================================= --}}
{{-- Tại sao chọn Kết nối Labo và Nha khoa --}}
{{-- ============================================= --}}
<section class="py-16 lg:py-28 bg-[#f5f5f7]">
    <div class="apple-container">
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div class="w-full lg:w-[38%] fade-in-up">
                <p class="text-sm font-semibold text-[#0071e3] tracking-wide uppercase mb-5">Tại sao chọn Kết nối Labo và Nha khoa?</p>
            ...
            <div class="w-full lg:w-[62%] fade-in-up" style="animation-delay: 0.15s;">
                <img loading="lazy" src="{{ home_url('wp-content/uploads/2022/08/clinic-dashboard') }}.png"
                     alt="Kết nối Labo và Nha khoa Dashboard - Phần mềm quản lý labo nha khoa giá rẻ, cho dùng thử miễn phí"
        ...
        <div class="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
            <div class="w-full lg:w-[62%] fade-in-up">
                <div class="bg-white rounded-3xl p-1 shadow-sm overflow-hidden border border-[#f5f5f7]">
                    <img src="@asset('images/connect-clinic-partner.webp')" alt="Giao diện Phòng khám - Phần mềm quản lý labo nha khoa giá rẻ, cho dùng thử miễn phí" class="rounded-2xl w-full h-full object-cover" loading="lazy">
                </div>
            </div>
...
<section class="py-16 lg:py-28 bg-white">
    <div class="apple-container">
        <div class="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
            <div class="w-full lg:w-[62%] fade-in-up">
                <div class="bg-white rounded-3xl p-1 shadow-sm overflow-hidden border border-[#f5f5f7]">
                    <img src="@asset('images/connect-lab-partner.webp')" alt="Cộng tác giữa các Labo - Phần mềm quản lý labo nha khoa giá rẻ, cho dùng thử miễn phí" class="rounded-2xl w-full h-full object-cover" loading="lazy">
                </div>
            </div>
            <div class="w-full lg:w-[38%] fade-in-up" style="animation-delay: 0.15s;">
        ...
        <div class="grid lg:grid-cols-2 gap-x-20 gap-y-20 max-w-5xl mx-auto">
            ...
            <div class="fade-in-up" style="animation-delay: 0.1s;">
                ...
                <div class="flex flex-wrap lg:flex-nowrap items-center gap-3 text-sm font-medium text-[#1d1d1f]">
                    ...
                    <span class="px-3 py-1.5 bg-white rounded-full border border-gray-200 whitespace-nowrap">Sản xuất</span>
                    <span class="text-[#86868b] font-bold">→</span>
    ...
    <div class="apple-container relative z-10">
        <div class="max-w-4xl mx-auto text-center fade-in-up">
            <h2 class="text-4xl lg:text-6xl font-bold text-white tracking-tight mb-10">
                ...
                <span class="block mt-3">Quản lý sản xuất</span>
            </h2>
            <p class="text-xl text-[#86868b] max-w-2xl mx-auto mb-20 leading-relaxed">
                Khác với các app gửi ca độc lập, Kết nối Labo và Nha khoa được tích hợp trực tiếp vào hệ thống sản xuất của Labo bạn
            </p>
        </div>
    ...
    <div class="apple-container">
        <div class="max-w-4xl mx-auto text-center mb-16 fade-in-up">
            ...
            <p class="text-xl text-[#86868b] mt-8 max-w-2xl mx-auto leading-relaxed">
                Kết nối Labo và Nha khoa biến Labo của bạn thành hệ sinh thái kết nối số
            </p>
        </div>
...
<section class="apple-section apple-section--cta relative overflow-hidden">
    ...
    <div class="apple-container text-center relative z-10">
        <div class="max-w-3xl mx-auto fade-in-up mb-16">
            <h2 class="text-2xl lg:text-3xl font-bold text-white mb-8">Kết nối Labo và Nha khoa dành cho ai?</h2>
