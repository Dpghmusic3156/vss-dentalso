<div class="post-sidebar-share" x-data="{ 
    ...
    <p class="post-toc__heading">Chia sẻ bài viết</p>
    <div class="post-sidebar-share__grid">
        ...
        <button @click="copyToClipboard()" 
            ...
            <span class="post-sidebar-share__tooltip" x-show="copied" x-transition>Đã sao chép!</span>
        </button>
    </div>
</div>
