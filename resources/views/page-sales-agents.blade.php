    ...
    <div class="apple-container text-center">
        <div class="fade-in-up">
            ...
            <div class="apple-cta-group mt-10">
                ...
                <a href="{{ home_url('products/dental-case-submission-software/') }}" class="apple-cta-secondary">Explore Connect<span class="apple-chevron material-symbols-outlined">chevron_right</span></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="apple-container">
        <div class="apple-split apple-split--reverse">
            <div class="apple-split-text fade-in-up">
                ...
                <div class="mt-8">
                    <a href="{{ home_url('products/dental-case-submission-software/') }}" class="apple-link">Learn more about Connect<span class="apple-chevron material-symbols-outlined">chevron_right</span></a>
                </div>
            </div>
